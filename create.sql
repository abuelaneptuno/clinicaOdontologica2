create table IF NOT EXISTS pacientes(id int auto_increment primary key,nombre varchar(255),apellido varchar (255),dni varchar (255));
...
create table IF NOT EXISTS turnos(id int auto_increment primary key, id_odontologo int, id_paciente int);
